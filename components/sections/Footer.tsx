      ...
      <Container>
        <div className="py-12 md:py-16">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {/* Company Info */}
            <div>
              <h3 className="text-xl font-bold">Gunnarstorps</h3>
              <p className="mt-4 text-gray-400">
                Vi arbetar med elinstallationer av både nya och gamla objekt med över 30 års erfarenhet.
              </p>
        ...
        <div className="border-t border-gray-800 py-6">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <div className="text-sm text-gray-500">
              © {currentYear} Gunnarstorps Elektrifieringsfirma. Alla rättigheter förbehållna.
            </div>
            <div className="flex space-x-6">
              <Link href="/integritetspolicy" className="text-sm text-gray-500 hover:text-white">
                Integritetspolicy
              </Link>
